  ...
  if(exist==null){
    try {
      ...
      const cal_wall = (main_gate, total_surface_area, window) => {
        ...
        let mortalBricks = (total_boundry * 144) / area_of_bricks_with_mortal;//2666
      ...
      if (req.body.kitchen == true) {
        ...
        kitchen_total_room_bricks = kitchenWall.bricks * req.body.no_of_roofs;
      ...
      if (exist == null) {
        try {
          ...
          return res
            .status(500)
            .json({ message: "error in the projects and  material database" });
        }
      }
    } catch (error) {
      return res.status(500).json(error);
       ...
       return res.status(500).json({message:"sorry the project name already existed"})
  }
